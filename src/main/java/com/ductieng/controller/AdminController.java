...
public class AdminController {
    ...
    public String saveProduct(
        ...
        try {
            ...
            try {
                com.ductieng.model.Laptop lap = laptopService.findById(saved.getId());
                if (lap != null) {
                    ...
                    for (int idx = 1; idx <= 5; idx++) {
                        ...
                        if (d != null && d.length > 0) {
                            lap.getImages().add(
                                    new com.ductieng.model.LaptopImage(
